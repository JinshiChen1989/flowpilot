 ...
 * 'sim_pose': slice(5973, 5985, None),
 * 'road_transform': slice(5985, 5997, None),
 * 'desired_curvature': slice(5997, 5999, None),
 * 'hidden_state': slice(5999, -1, None),
 ...
 * 'prev_desired_curv': (1, 100, 1), 'features_buffer': (1, 99, 512)}, 'output_shapes': {'outputs': (1, 6512)}}
 *
 *
 * Inputs: (NOTRE DAME)
 *
...
const int FEATURE_BUF_OFFSET = 5999;
